...
export default function TeamReports() {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      const url = `/api/teams/${teamSlug}/reports${queryParams.toString() ? '?' + queryParams.toString() : ''}`
      ...
      const mockReports: Report[] = [
        {
          id: '1',
          title: `Relatório de Performance - ${currentTeam.name}`,
          content: `Análise detalhada da performance do sistema para o team ${currentTeam.name} durante o último mês...`,
          status: 'PUBLISHED',
      ...
      <div className="flex min-h-screen bg-gray-50">
        ...
        <main className="ml-64 flex-1 p-8 pt-4">
          <div className="text-center py-12">
            <h1 className="text-2xl font-bold text-gray-900 mb-4">Team não encontrado</h1>
            <p className="text-gray-600">Não foi possível carregar as informações do team.</p>
          </div>
        </main>
      </div>
    )
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">Relatórios - {currentTeam.name}</h1>
                  <p className="text-gray-600 mt-1">Visualize análises e relatórios da base de conhecimento do team</p>
                </div>
              </div>
              <Link
                href={`/team/${teamSlug}/reports/new`}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Link
                            href={`/team/${teamSlug}/reports/${report.id}/edit`}
                          ...
                          <Link
                            href={`/team/${teamSlug}/reports/${report.id}`}
